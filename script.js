...
const CONTRASENA = "060223"; // Cambia esto por la contraseña que desees
...
function actualizarContador() {
    const fechaInicio = new Date('2023-02-06T00:00:00'); // Fecha base
    const ahora = new Date();

    let diferencia = ahora - fechaInicio;

    // Convertir la diferencia en tiempo real
    ...
    // Calcular años, meses y días correctamente
